...
user.register = async function register (address, exchange, apiKey, apiSecret, userType, fullname, email, asset, passphrase) {
  return mysql.query(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
  `, [address, exchange, apiKey, apiSecret, userType, fullname, email, asset, passphrase]);
};
